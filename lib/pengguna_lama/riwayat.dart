...
import 'package:homital/pengguna_lama/laporan/coba_absen_cek.dart';
import 'package:homital/pengguna_lama/laporan/laporan_absensi.dart';
...
class _laporanabsenState extends State<laporanabsen> {
  ...
  Future ambilfilter() async {
    ...
    final Response = await http.post(
        ...
        body: {
          "pegawai_id": id_user == "" ? pegawaiid : id_user,
          "aksi": "2",
          "aksi": "2"
        });
    var _data = jsonDecode(Response.body);
