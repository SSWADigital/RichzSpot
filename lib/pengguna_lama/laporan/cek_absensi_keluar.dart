...
class CekAbsen_Keluar extends StatefulWidget {
  const CekAbsen_Keluar({Key key, this.absensiId}) : super(key: key);
  final String absensiId;
  @override
  _CekAbsen_KeluarState createState() => _CekAbsen_KeluarState();
}

class _CekAbsen_KeluarState extends State<CekAbsen_Keluar> {
  //Tests Items
