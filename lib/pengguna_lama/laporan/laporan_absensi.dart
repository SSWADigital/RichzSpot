...
import 'package:homital/pengguna_lama/laporan/cek_absensi_keluar.dart';
import 'package:homital/pengguna_lama/laporan/cek_absensi_masuk.dart';
...
class _detailabsensiState extends State<detailabsensi>
  ...
  Future ambildata() async {
    ...
    final Response = await http.get(
      Uri.parse("103.157.97.200/richzspot/absen/getAbsenHistoryDetail/$id"),
    );
    ...
    if (_data == false) {
      ...
      this.setState(() {
        absensiId = _data[0]['absen_id'];
        idUser = _data[0]['id_user'];
        tanggal = _data[0]['tanggal'];
        checkIn = _data[0]['absen_checkin'];
        checkOut = _data[0]['absen_checkout'];
        locCheckIn = _data[0]['absen_checkin_lokasi'];
        locCheckOut = _data[0]['absen_checkout_lokasi'];
        fotoCheckIn = _data[0]['absen_checkin_foto'];
        fotoCheckOut = _data[0]['absen_checkout_foto'];
      });
    }
  }
